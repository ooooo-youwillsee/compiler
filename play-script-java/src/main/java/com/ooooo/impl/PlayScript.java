...
public class PlayScript {
  ...
  public static void main(String args[]) {
    ...
    //String script = "class class1{int a=2; int b; void method1(){println(\"in class1\");}} class class2 extends class1{int b = 5; void method1(){println(\"in class2\");} }
    // class1 c = class2(); println(c.a); println(c.b); c.method1();";
    ...
    //String script = "int fun1(int x1, int x2, int x3, int x4, int x5, int x6, int x7, int x8){int c = 10; return x1 + x2 + x3 + x4 + x5 + x6 + x7 + x8 + c;} println(\"fun1:
    // %d\", fun1(1,2,3,4,5,6,7,8));".replaceAll("\\\\", "");
